...
» Owner instagram.com/chyangrhaa
...
%readmore`
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(galang)).buffer(), caption.trim(), '𝙒𝙝𝙖𝙩𝙨𝘼𝙥𝙥 𝘽𝙤𝙩', 'Sewa Bot', `${_p}sewabot`, 'Donasi', `${_p}donasi`, m)
  } catch (e) {
